...
class TestShakerMetadata(TestCase):
    ...
    @patch('shaker.shaker_metadata.ShakerMetadata.load_local_metadata')
    @patch('shaker.shaker_metadata.ShakerMetadata.load_local_requirements')
    def test__parse_metadata_requirements_simple_with_blanks(self,
                                                 mock_load_local_requirements,
                                                 mock_load_local_metadata,
                                                 mock_fetch_local_metadata):
        """
        TestShakerMetadata: Test that blanks are accepted in the constraint
        """
        requirements = [
            'test_organisation/some-formula == v1.0',
            'test_organisation/another-formula >= v2.0',
            'test_organisation/a-third-formula == a_Branch',
            'test_organisation/a-fourth-formula==a_Branch',
        ]
        ...
        expected_result = {
            ...
            'test_organisation/a-third-formula':
            {
                'source': 'git@github.com:test_organisation/a-third-formula.git',
                'constraint': '==a_Branch',
                'sourced_constraints': [],
                'organisation': 'test_organisation',
                'name': 'a-third-formula'
            },
            'test_organisation/a-fourth-formula':
            {
                'source': 'git@github.com:test_organisation/a-fourth-formula.git',
                'constraint': '==a_Branch',
                'sourced_constraints': [],
                'organisation': 'test_organisation',
                'name': 'a-fourth-formula'
            },
        }
        ...
        self.assertEqual(actual_result,
                         expected_result,
                         "TestShakerMetadata::test__parse_metadata_requirements_simple_with_blanks: Mismatch\n"
                         "Actual: %s\nExpected: %s\n\n"
                         % (actual_result, expected_result))
